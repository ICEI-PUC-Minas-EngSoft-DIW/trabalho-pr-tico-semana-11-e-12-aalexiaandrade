...
**GET**
![Teste GET](test_get.PNG)

**POST**
![Teste POST](test_post.PNG)

**PUT**
![Teste PUT](test_put.PNG)

**DELETE**
![Teste DELETE](test_delete.PNG)

**Print da aba NETWORK com requisições Fetch/XHR POST e GET**

(Eu vi que você tem o `produto_cadastrado.PNG`. Usei esse para o POST. Para o GET, basta tirar um print recarregando a página `index.html` como fizemos).

**Network POST (Ao Cadastrar Produto)**
![Network POST](produto_cadastrado.PNG)

**Network GET (Ao Carregar a Home)**
![Network POST](produto_alterado.PNG)
